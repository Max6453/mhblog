...
export const meta = {
  title: "Oracle stocks",
  excerpt: "Meteoric rise for oracle",
    ...
    return(
        ...
        <Header/>
          <ScrollProgress />
            ...
            <h1 className="absolute text-6xl top-82 left-20 z-10 font-josefin-sans max-md:left-7 items-baseline max-md:top-20 md:text-3xl sm:text-xl lg:text-6xl max-md:text-3xl text-background text-center font-bold">
            ...
            <div className="relative pb-10 md:left-0">
                ...
                If you've been following the stock market, you've probably noticed Oracle's stock has been on an absolute tear, surging by over 30% in a single day.
                This isn't just a flash in the pan; it's a fundamental re-evaluation of the company's future, and it all boils down to one word: AI.
                </p>
                 <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-0 max-md:w-90 max-lg:w-200 xl:w-300 font-josefin-sans pt-15">
                For years, Oracle has been seen as a legacy tech giant, but its latest announcements have put it squarely at the center of the AI revolution.
                Here’s a breakdown of the key factors that lit the fuse on this incredible rally.
                </p>
                <h3 className="text-4xl m-5 lg:pl-75 pt-5">What Sparked the Rally?</h3>
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-0 max-md:w-90 max-lg:w-200 xl:w-300 font-josefin-sans pt-15">
                Several key developments fueled the spike.
                </p>
                <h3 className="text-4xl m-5 lg:pl-75 pt-5">AI Cloud Demand Explodes</h3>
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-0 max-md:w-90 max-lg:w-200 xl:w-300 font-josefin-sans pt-15">
                Oracle’s Remaining Performance Obligations (RPO)—a measure of contracted but not yet recognized revenue—rocketed 359% year-over-year to $455 billion in Q1 FY2026.
                </p>
                <h3 className="text-4xl m-5 lg:pl-75 pt-5">Raised Cloud Revenue Forecasts</h3>
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-10 max-md:pl-50 font-josefin-sans pt-15 lg:w-300">
                Oracle raised its OCI revenue forecast to 77% growth this fiscal year, now expecting $18 billion—up from a prior projection of about 70%. 
                The company sees cloud infrastructure revenue expanding to $144 billion within five years.
                </p>
                <h3 className="text-4xl m-5 lg:pl-75 pt-5">Major Multibillion-Dollar Deals</h3>
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-10 max-md:pl-50 font-josefin-sans pt-15 lg:w-300">
                Oracle disclosed it closed four multibillion-dollar contracts with three separate customers during the quarter, in addition to strong partnerships with OpenAI and other AI powerhouses. 
                Some reports even mention a $30 billion annual cloud contract set to begin in FY2028.
                </p>
              </div>
            </div>
            <footer

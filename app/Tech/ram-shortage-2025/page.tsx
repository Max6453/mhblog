...
export default function ArticleRam() {
    return(
        <div>
            ...
            mainText
            ="The memory market is currently facing an unprecedented crisis that is fundamentally shifting the economics of computer hardware.
            ...
            upperTitle
            ="Could AI drastically change RAM market?"
            lowerText

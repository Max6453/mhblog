...
export default function Account() {
        ...
        <div className="bg-white text-black">
          ...
          <div className="fixed h-screen" />
            ...
            <main className="bg-white h-screen relative">
                <h1 className='text-4xl pt-4'>Welcome back, Maxim</h1>
  ...
  <div className='w-full h-full fixed top-0 pt-60 bg-blue-500 text-center text-6xl'>
    <img src="/mobileIcon-navbar.png" className='size-50 absolute top-5 left-19'/>
    <h1 className=''>Return soon, this page is still in development phase</h1>
    <a href='/Mobile'>
    <button className='rounded-full relative bg-white border border-black outline-1 text-3xl w-80 h-20 top-10 hover:bg-neutral-950 hover:border-cyan-400 duration-300 hover:text-white'>
        return home
    </button>
        </a>
  </div>

...
export default function Contact() {
  return (
   <div> 
      <div className="flex flex-col fixed z-50 top-140 pl-8 items-center justify-center max-sm:block md:hidden lg:hidden xl:hidden 2xl:hidden max-md:hidden">
      <TooltipProvider>
        <Dock direction="middle" className='bg-neutral-950'>
            ...
            <div className="col-span-full">
              <div className="mt-2">
                <textarea
                  ...
                  rows={3}
                  className="block lg:w-300 md:w-200 max-md:w-150 max-sm:w-80 h-100 max-lg:left-30 lg:left-20 max-md:left-10 max-sm:left-3 relative rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                  defaultValue={''}
                />
              </div>
            </div>

          ...
          <ScrollProgress />
            ...
            <div className="relative pb-10 md:left-0">
                ...
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-10 max-md:w-90 lg:w-300 font-josefin-sans pt-15">
                    Could Lando Norris definetely win championship in Qatar?
                </p>
                 <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-0 max-md:w-90 max-lg:w-200 xl:w-300 font-josefin-sans pt-15">
                    Unfortunately, Because of time zones, I was able to watch only the race.
                </p>
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-0 max-md:w-90 max-lg:w-200 xl:w-300 font-josefin-sans pt-15">
                    LN4 started the race already bad. He was too much focused on covering MV1, that he entirely missed his brake point which resulted in losing positions to MV1 and GR63.
                    And from there it was only straightforward race for them.
                    Meanwhile more back in the field, GB5 crashed in LS18 which resulted in DNF.
                    Also Hamilton made a fine improvement from where he started. From P20 to P13 in single lap is a good performance.
                    AKA12 also had no time to lose and quickly advance forward.
                    Overall race was more boring with a Max verstappen winning the Las Vegas Grand Prix with 20 second gap to 2nd Lando Norris and 3rd George Russell.
                    But LN4 suffered from lack of fuel so he needed to lift and coast more than usual.
                ...
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-10 max-md:pl-50 font-josefin-sans pt-15 lg:w-300"> 
                    Overall disappointing race from motorsport fanatic and mclaren fan.
                    But looking forward to Qatar which will be sprint weekend and also an opportunity for LN4 to win a championship.
                    Next stop: Lusail, Qatar.
                </p>
              </div>
             </div>
            <footer

          ...
          <ScrollProgress />
            ...
            <div className="relative pb-10 md:left-0">
                ...
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-10 max-md:w-90 lg:w-300 font-josefin-sans pt-15">
                    Grand finale of 2025 Formula 1 season
                </p>
                 <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-0 max-md:w-90 max-lg:w-200 xl:w-300 font-josefin-sans pt-15">
                    2025 season was full of ups and downs, dominations, disputes, controversions, mistakes but also exiting and fun to watch.
                    On sunday, we will meet either old or new formula 1 champion.
                </p>
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-0 max-md:w-90 max-lg:w-200 xl:w-300 font-josefin-sans pt-15">
                    As for mandatory rookie FP1 outings, these drivers will sit in the cockpits:
                    Pato O'Ward – McLaren. <br/>
                    Arthur Leclerc – Ferrari.<br/>
                    Arvid Lindblad – Red Bull.<br/>
                    Luke Browning – Williams. <br/>
                    Ayumu Iwasa – Racing Bulls.<br/>
                    Ryo Hirakawa – Haas. <br/>
                ...
                <p className="text-start text-2xl lg:pl-20 max-sm:pl-2 md:pl-0 font-josefin-sans pt-15">
                    ...
                    The track offer us multiple high speed sectors with 2 DRS straight and slow, narrow 3rd sector.
                    The tyre wear is significant on the front right but the rears are also loaded more.
                    Ofcourse, the mclaren is more preferable team to lead, as their tyre cooling is better than red bulls and also their cornering speeds around high speed and low speed corners.
                    On the other hand, Red bull dominates over Mclaren in top speeds and in medium speed corners.
                    I think that Mclaren will lose time on straights and in T1,T13, T14. In T5 and T10, we will be wiser after friday.
                    My take is that championship contenders will place themselves in 0.2 seconds apart.   
                </p>
                <ul className="flex gap-2 flex-col hover:scale-110 duration-300 hover:shadow-lg shadow-black backdrop-blur">
                <img src="/assets/abu_dhabi_circuit.avif"/>
                <img src="/assets/pirelli-AD.jpg"/>
                </ul>
                </div>
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-10 max-md:pl-50 font-josefin-sans pt-15 lg:w-300"> 
                    Right now, we will be wiser tommorow so be ready to watch our blog for free practice analysis.
                    And also I would recommend for you to download our official mobile app where you will have newest articles ready for reading.

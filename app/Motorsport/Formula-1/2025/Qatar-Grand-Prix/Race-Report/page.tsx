          ...
          <ScrollProgress />
            ...
            <div className="relative pb-10 md:left-0">
                ...
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-10 max-md:w-90 lg:w-300 font-josefin-sans pt-15">
                    MV1 Victorious and fair mclaren strikes again.
                </p>
                 <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-0 max-md:w-90 max-lg:w-200 xl:w-300 font-josefin-sans pt-15">
                    Title will be decided in Abu Dhabi as Max Verstappen wins in Qatar.
                </p>
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-0 max-md:w-90 max-lg:w-200 xl:w-300 font-josefin-sans pt-15">
                    Whole weekend we knew that this track suits the mclaren. 
                    But we also knew that Max verstappen will be close.
                    Whole weekend was dominated by Oscar Piastri who performed like at the beginning of the season.
                    On the other hand, Lando Norris lost some of his pace from previous races. but also we saw old LN4 from the beginning of the season.
                    He made multiple mistakes in mainly qualifying sessions.
                    Ferrari was terible whole weekend. No sign of speed.
                    Mercedes was competetive the most from the field.
                </p>
                ...
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-10 max-md:pl-50 font-josefin-sans pt-15 lg:w-300"> 
                    OP81 managed to stay infront of LN4 and MV1.
                    MV1 overtook LN4 into T1.
                    Overall whole left side of the grid had better launch as the left side is better rubbered and have overall better grip.
                    From this point it was straightforward.
                    Until 7th lap where PG10 and NH27 collided in T1 which caused a safety car.
                    17 out of 20 cars pitted for fresher tyres. Only both Mclarens and ocon didn't pitted.
                    This decision ultimately lost a potential win for OP81 and podium for LN4.
                    But CS55 capitalised the most of this opportunity which elevated him into P3 where he also finished the race.
                    Because of the profile of the track, it was imposibble to overtake.
                    MV1 wins in Qatar Grand Prix tighting the gap to 12 points.
                    OP81 tightens the gap too to 16 points.
                    LN4 only needs to finish on the podium in Abu Dhabi to secure the championship.
                    MV1 with OP81 must win and LN4 needs to be place below from P4 to P6.
                </p>
                <p className="text-start text-2xl lg:pl-80 max-sm:pl-2 md:pl-10 max-md:pl-50 font-josefin-sans pt-15 lg:w-300"> 
                    Lusail circuit was build mainly for motoGP's. It was never a track for F1.
                    Thus we had nearly to 0 overtakes on track.
                    Already looking forward to season finale in Abu dhabi.
                    Last stop: Abu Dhabi, United Arab Emirates.
                </p>
              </div>
             </div>
            <footer

...
<div className='relative h-screen' id='Latest'>
 ...
 {/* FOOTER */}
    ...
    <aside className="relative text-center items-baseline pr-20 xl:top-50 lg:top-80 md:top-125 max-md:top-165 max-sm:top-180 max-md:text-lg max-md:text-center max-sm:pl-18">

...
export default function Example() {
  return (
  <div>  
    <Disclosure as="nav" className="bg-white h-30 relative max-md:fixed max-md:w-full">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative h-16 justify-between">
          ...
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            {/* Mobile menu button*/}
            <DisclosureButton className="group relative inline-flex items-end left-130 pt-10 justify-center rounded-md p-2 text-black hover:bg-white hover:text-blue-500 focus:ring-2 focus:ring-white focus:outline-hidden focus:ring-inset">
      ...
      <DisclosurePanel className="sm:hidden transition-all duration-300">
    ...
    <div className="relative pt-20 grid lg:grid-cols-3 md:grid-cols-2 grid-rows-3 gap-10 pl-10 max-md:pl-30 sm:grid-cols-2 -z-10">
    ...
    <section className='relative bg-white h-screen top-10'>
      <div>
      <h1>About</h1>
      </div>
    </section>

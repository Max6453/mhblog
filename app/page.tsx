...
<div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="-mt-12 -ml-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <h3 className='text-blue-500 text-6xl bold font-Exo-2 pb-3'>latest news</h3>
          <h4 className='z-50 absolute text-white top-30 pt-3 pl-1 bold font-Exo-2 text-3xl'>Spanish grand prix debriefing</h4>
          <img
            alt=""  
        ...
        <button className='bg-white border border-blue-500 relative bottom-20 max-md:-left-4.5 left-80 text-black font-Exo-2 rounded-full w-45 h-15 hover:bg-blue-500 hover:border-white hover:text-white transition duration-300'>
          See more</button>
        </a>
        </div>
